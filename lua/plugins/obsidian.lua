...
local function on_buffer_first_enter()
    ...
    vim.keymap.set('n', 'gi', '<cmd>cd ~/Extended Mind/<cr><cmd>e index.md<cr>', { buffer = true, })
    vim.keymap.set('n', 'gc', '<cmd>cd ~/Extended Mind/<cr><cmd>e context.md<cr>', { buffer = true, })
    ...
    vim.keymap.set('n', 'gp', '<cmd>cd ~/Extended Mind/<cr><cmd>e areas/photography/index.md<cr>', { buffer = true, })
