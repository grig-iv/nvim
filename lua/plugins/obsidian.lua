...
local function on_buffer_first_enter()
    ...
    vim.keymap.set('n', 'gi', '<cmd>e index.md<cr>', { buffer = true, })
    vim.keymap.set('n', 'gc', '<cmd>e context.md<cr>', { buffer = true, })
    vim.keymap.set('n', 'gw', '<cmd>e work/index.md<cr>', { buffer = true, })
    vim.keymap.set('n', 'gh', '<cmd>e areas/home/index.md<cr>', { buffer = true, })
    vim.keymap.set('n', 'gs', '<cmd>e areas/sport/index.md<cr>', { buffer = true, })
    vim.keymap.set('n', 'gp', '<cmd>e areas/photography/index.md<cr>', { buffer = true, })
